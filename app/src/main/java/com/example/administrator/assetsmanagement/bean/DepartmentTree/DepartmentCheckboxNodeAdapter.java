...
import com.example.administrator.assetsmanagement.bean.DepartmentTree.DepartmentTreeNodeAdapter;
...
public class DepartmentCheckboxNodeAdapter extends DepartmentTreeNodeAdapter<DepartmentCheckboxNodeAdapter.MyViewHolder> {
    DepartmentNodeSelected selectedListener;

    public DepartmentCheckboxNodeAdapter(Context context, List<Department> datas, int defaultExpandLevel, int iconExpand, int iconNoExpand) {
        super(context, datas, defaultExpandLevel, iconExpand, iconNoExpand);
    }

    public DepartmentCheckboxNodeAdapter(Context context, List<Department> datas, int defaultExpandLevel) {
        super(context, datas, defaultExpandLevel);
    }

    @Override
    public void onBindViewHolder(final Department node, RecyclerView.ViewHolder holder, final int position) {
        final MyViewHolder myViewHolder = (MyViewHolder) holder;
        myViewHolder.mNodeName.setText(node.getDepartmentName());
        if (node.isChecked()) {
     ...
     */
    public void setCheckBoxSelectedListener(DepartmentNodeSelected selectedListener) {

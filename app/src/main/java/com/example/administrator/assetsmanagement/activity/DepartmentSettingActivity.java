...
public class DepartmentSettingActivity extends ParentWithNaviActivity {
    ...
    public void addToBmob(BaseNode node) {
        ...
        depa.save(this, new SaveListener() {
            @Override
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case UPDATE_FLAG:
                    ...
                    depa.update(DepartmentSettingActivity.this,objectId, new UpdateListener() {
                        @Override
                        public void onSuccess() {
                            toast("修改成功！");
                        }
                ...
                case DELETE_FLAG:
                    ...
                    depa.delete(DepartmentSettingActivity.this, new DeleteListener() {
                        @Override
                        public void onSuccess() {
                            toast("删除成功");
                        }

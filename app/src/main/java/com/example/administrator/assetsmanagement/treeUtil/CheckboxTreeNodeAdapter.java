...
public class CheckboxTreeNodeAdapter extends NodeRecyclerViewAdapter<CheckboxTreeNodeAdapter.MyViewHolder> {
    TreeNodeSelected selectedListener;

    public <T> CheckboxTreeNodeAdapter(Context context, List<T> datas, int defaultExpandLevel, int iconExpand, int iconNoExpand) {
        super(context, datas, defaultExpandLevel, iconExpand, iconNoExpand);
    }

    public <T> CheckboxTreeNodeAdapter(Context context, List<T> datas, int defaultExpandLevel) {

...
public class CategoryCheckboxNodeAdapter extends CategoryTreeNodeAdapter<CategoryCheckboxNodeAdapter.MyViewHolder> {
    CategoryNodeSelected selectedListener;

    public CategoryCheckboxNodeAdapter(Context context, List<AssetCategory> datas, int defaultExpandLevel, int iconExpand, int iconNoExpand) {
        super(context, datas, defaultExpandLevel, iconExpand, iconNoExpand);
    }

    public CategoryCheckboxNodeAdapter(Context context, List<AssetCategory> datas, int defaultExpandLevel) {
        super(context, datas, defaultExpandLevel);
    }

    @Override
    public void onBindViewHolder(final AssetCategory node, RecyclerView.ViewHolder holder, final int position) {
        final MyViewHolder myViewHolder = (MyViewHolder) holder;
        myViewHolder.mNodeName.setText(node.getCategoryName());
        if (node.isChecked()) {
     ...
     */
    public void setCheckBoxSelectedListener(CategoryNodeSelected selectedListener) {
